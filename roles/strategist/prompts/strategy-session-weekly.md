...
3. **Измерь C_act:** max уровень охвата (`PD.FORM.090`) с lifework-документом, действующим ≥6 мес. Если lifework-пакета нет — C_act=0, рекомендуй создать Личный устав (уровень 1) первым
