...
**Единый источник — календарный коннектор** (MCP-инструменты календаря, имена зависят от установки, шаблон `mcp__*calendar*`): получить список календарей, затем события каждого за день. Классификация и формат — те же, что ниже у скрипта.
